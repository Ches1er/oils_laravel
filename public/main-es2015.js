...
let MainPropertiesService = class MainPropertiesService {
    ...
    ilsac(definer) {
        return this.http.get(this.urlConfig.GETILSAC + '/' + definer)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(resp => _dto_mainProperties_IlsacResponse__WEBPACK_IMPORTED_MODULE_8__["IlsacResponse"].fromJson(resp)))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(ir => ir.data));
    }
...
let ToService = class ToService {
    ...
    models(id) {
        return this.http.get(this.urlConfig.GETMODELS + id)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(resp => _dto_to_model_ModelResponse__WEBPACK_IMPORTED_MODULE_10__["ModelResponse"].fromJson(resp)))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(br => br.data));
    }
    autos(id) {
    ...
    get groups() {
        return this.http.get(this.urlConfig.GETGROUPS)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(resp => _dto_to_groups_GroupResponse__WEBPACK_IMPORTED_MODULE_7__["GroupResponse"].fromJson(resp)))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(gr => gr.data));
    }
    get exchanges() {
        return this.http.get(this.urlConfig.GETEXCHANGES)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(resp => _dto_to_priceExchange_PriceExchangeResponse__WEBPACK_IMPORTED_MODULE_8__["PriceExchangeResponse"].fromJson(resp)))
    ...
    goods(id, exchange) {
        return this.http.get(this.urlConfig.GETAUTOGOODS + id + '/' + exchange)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(resp => _dto_to_goods_GoodsResponse__WEBPACK_IMPORTED_MODULE_6__["GoodsResponse"].fromJson(resp)))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(gr => gr.data));
    }
    addExchange(data, action) {
        ...
        return this.http.post(this.urlConfig.ADDEXCHANGE, params)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(resp => _dto_ServerResponse_ServerResponse__WEBPACK_IMPORTED_MODULE_9__["ServerResponse"].fromJson(resp)))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(sr => sr.response));
    }
